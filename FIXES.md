...
**Error**: `com.ava.ai.presentation.settings.SettingsActivity` not found
...
```xml
<!-- Before -->
android:settingsActivity="com.ava.ai.presentation.settings.SettingsActivity"

<!-- After -->
android:settingsActivity="com.ava.ai.presentation.main.MainActivity"
```
...
7. ✅ **Start Using** - Say "Hey Ava" and enjoy!
