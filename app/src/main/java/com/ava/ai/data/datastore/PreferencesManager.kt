package com.ava.ai.data.datastore

import android.content.Context
import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.*
import androidx.datastore.preferences.preferencesDataStore
import com.ava.ai.data.models.AIProvider
...
class PreferencesManager(private val context: Context) {
    ...
    companion object {
        ...
        private val AVA_ACTIVE = booleanPreferencesKey("ava_active")
    ...
    val avaActive: Flow<Boolean> = context.dataStore.data.map { 
        it[AVA_ACTIVE] ?: false 
    }
    suspend fun setMayaActive(active: Boolean) {
        context.dataStore.edit { it[AVA_ACTIVE] = active }
    }
