package com.ava.ai.ai.providers
...
class OpenAIClient(
    ...
    private fun buildMessageList(
        ...
        messages.add(
            ChatMessage(
                role = "system",
                content = "You are Ava, a helpful AI assistant. You can control the phone, read messages, make calls, and help with various tasks. Be concise and friendly. Support both English and Bengali."
            )
        )
